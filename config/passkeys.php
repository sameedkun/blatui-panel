...
return [
    ...
    'actions' => [
        ...
        // Re-checks isStaff()/not-banned/panel access after the credential itself checks out —
        // mirrors the same guard App\Livewire\Auth\Login::login() applies to a password login.
